...
import com.sxw.unittestdemo.di.component.DaggerLoginComponent;
import com.sxw.unittestdemo.di.module.LoginModule;
import com.sxw.unittestdemo.mvp.base.BaseActivity;
import com.sxw.unittestdemo.mvp.base.BaseDaggerActivity;
...
public class DaggerLoginActivity extends BaseDaggerActivity<LoginPresenter> implements ILoginView{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DaggerLoginComponent.builder()
                .loginModule(new LoginModule(new LoginModelImpl(),this))
                .build()
                .inject(this);
    }
